...
class DaMai:
    ...
    def __init__(self, cfg: Config):
        self.cfg = cfg
        path = r'/Applications/Microsoft Edge.app/Contents/MacOS/Microsoft Edge'  # 请改为你电脑内Chrome可执行文件路径
    ...
    def buy(self):
        ...
        print(f'设置购票人数:{self.cfg.ticket_num}')
        for i in range(1,self.cfg.ticket_num):
            self.page.ele('.bui-svg-icon icon-couter-btn plus-enable').click()
